...
class Jeu extends Component {
  constructor(props) {
    ...
    const sponsors = sport.sponsors.map((sponsorId) =>
  ...
  getCountryInfo(countryNames) {
    return countryNames.map((countryName) =>
      this.data.getCountries().find((country) => country.name === countryName)
    );
  }
          ...
          children: [
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  children: this.state.sport.description.reduce(
                    (acc, text, index) => {
                      if (index > 0) {
                        acc.push({ type: "br" });
                      }
                      acc.push({
                        ...
                        attributes: {
                          class:
                            "flex justify-center lg:mt-[56.8px] items-center text-center px-[1.813rem] lg:px-[73.84px] font-texte lg:text-[35.5px]",
                        },
                        children: [text],
                      });
                      return acc;
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  attributes: {
                    class:
                      "flex justify-center items-center my-[2.5rem] lg:mt-[28.4px]",
                  },
                  children: [
                    {
                      type: "div",
              ...
              children: [
                {
                  ...
                  attributes: {
                    class:
                      "font-bold pt-[8px] text-left pl-[32px] mt-[2rem] lg:text-[56.8px] lg:mt-[102.24px] text-[40px] font-title",
                  },
                ...
                },
                {
                  ...
                  attributes: {
                    class:
                      "grid grid-cols-2 lg:grid-cols-3 gap-x-[80px] lg:gap-x-[56.8px] gap-y-[24px] px-[56px] pt-[16px] lg:pt-[56.8px] pb-[40px] lg:pb-[102.24px]",
                  },
                  children: this.state.sponsors.map((sponsor) =>
        ...
        children: [
          {
            type: "div",
            attributes: {
              class: "text-center lg:text-[56.8px]",
            },
  ...
  renderEvent(event) {
    ...
    const time = new Date(event.schedule).toLocaleTimeString([], {
      hour: "2-digit",
      minute: "2-digit",
    });
    const title = `${this.state.sport.name} - ${
      event.categories[0] || "groupe"
    }`;
  ...
  renderMatch(time, title, team1, team1Logo, team2, team2Logo) {
    return {
      ...
      attributes: {
        class:
          "border rounded-lg mb-[24px] lg:mb-[56.6px] lg:mx-auto lg:w-[852px] lg:h-[360.68px] flex flex-col",
      },
      children: [
        {
          type: "div",
          attributes: {
            class:
              "text-black-400 lg:text-[35.5px] pt-[16px] lg:pt-[39.76px] pl-[24px] lg:pl-[56.8px]",
          },
          children: [
            {
              type: "span",
        ...
        },
        {
          ...
          attributes: {
            class:
              "flex justify-center lg:text-[35.5px] items-center space-x-[16px] pb-[32px] lg:space-x-[42.6px]",
          },
          children: [
            {
              type: "div",
              ...
              children: [
                {
                  ...
                  attributes: {
                    src: team2Logo,
                    class:
                      "w-[33px] lg:w-[76.68px] h-[24px] lg:h-[54.67px] text-black-400",
                    alt: team2,
                  },
                },
                {
